...
json.result do
  ...
  json.nationality @rs.nationality.name.upcase rescue ''
  json.marital @rs.marital.name.upcase  rescue ''
  json.gender @rs.gender.name.upcase rescue ''
  json.race @rs.race.name.upcase  rescue ''
  json.religion @rs.religion.name.upcase  rescue ''
  json.bloodtype @rs.bloodtype.name.upcase rescue ''
